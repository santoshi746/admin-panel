    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                ...
                <div class="sidebar-brand-text mx-3">Nirmaan Organization</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">COARSES NAMES:</h6>
                        <a class="collapse-item" href="#">WMA</a>
                        <a class="collapse-item" href="#">OA</a>
                        <a class="collapse-item" href="#">ITES</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="technical.php">Technical</a>
                        <a class="collapse-item active" href="soft.php">Softskills</a>
                        <a class="collapse-item" href="cert.php">Certification</a>
                        <a class="collapse-item" href="place.php">Placements</a>
                    </div>
                </div>
            </li>
